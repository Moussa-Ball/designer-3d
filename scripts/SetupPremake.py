...
class Premake:
    ...
    def InstallPremake(cls):
        ...
        SetupUtils.DownloadFile(cls.premakeZipUrls, premakePath)
        print("Extracting", premakePath)
        SetupUtils.UnzipFile(premakePath, deleteZipFile=True)
        print(
        ...
        SetupUtils.DownloadFile(cls.premakeLicenseUrl, premakeLicensePath)
        print(
